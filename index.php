                ...
                if($stmt = $pdo->prepare($sql)){
                    ...
                    if($stmt->execute()){
                        if($row = $stmt->rowCount() > 0){
                            echo '<table class="table table-striped table-sm"><thead class="thead"> <tbody><tr><th><svg width="1em" height="3em" viewBox="0 0 16 16" class="bi bi-person-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path d="M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"/>
  <path fill-rule="evenodd" d="M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
  <path fill-rule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"/>
</svg> Hostname</th><th> <svg width="1em" height="3em" viewBox="0 0 16 16" class="bi bi-cpu" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
</svg> CPU </th><th><svg width="1em" height="3em" viewBox="0 0 16 16" class="bi bi-laptop" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M13.5 3h-11a.5.5 0 0 0-.5.5V11h12V3.5a.5.5 0 0 0-.5-.5zm-11-1A1.5 1.5 0 0 0 1 3.5V12h14V3.5A1.5 1.5 0 0 0 13.5 2h-11z"/>
  <path d="M0 12h16v.5a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5V12z"/>
</svg> OS</th></tr>';
                            while($row = $stmt->fetch()) {
                                echo "<tr><td>" . $row["hostname"]. "</td><td>" . $row["architecture"]. "</td><td>" . $row["os"]. "</td></tr>";
                            }
                            echo "</tbody></table>";
                        }else { echo '<div class="alert alert-info" role="alert">No remote hosts found. Have a look at <strong><a data-toggle="modal" data-target="#exampleModal" href="#">Getting started!</a></strong></div>';}
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img width="90%" src="https://i.kym-cdn.com/photos/images/original/001/385/982/e31.png">
                            </div>
